...
if ( ! class_exists( 'WpssoWcmd' ) ) {
	...
	class WpssoWcmd extends SucomAddOn {

		/**
		 * Library class object variables.
		 */
		public $filters;	// WpssoWcmdFilters class.
		public $reg;		// WpssoWcmdRegister class.
		 ...
		 */
		protected $p;
		protected $ext   = 'wpssowcmd';
		protected $p_ext = 'wcmd';
		protected $cf    = array();
		...
		public function __construct() {
			...
			add_action( 'wpsso_init_check_options', array( $this, 'init_check_options' ), 10, 0 );
