...
<p>Absolutely. Assuming the product information isn't already available from WooCommerce, and fits in a <a href="https://schema.org/Product">Schema Product property</a>, <a href="https://wordpress.org/support/plugin/wpsso-wc-metadata/">create a new topic in the plugin support forum</a> with the details (including the suggested Schema property name) and we'll have a look. ;-)</p>
