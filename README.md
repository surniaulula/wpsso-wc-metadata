...
<p>The product global identifier values (ie. MPN, ISBN, GTIN-14, GTIN-13 (EAN, GTIN-12 (UPC), GTIN-8, and GTIN) are searchable from both the front-end, and the back-end WooCommerce Products admin page.</p>
