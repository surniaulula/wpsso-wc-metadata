...
<p><strong>Product global identifier field values (GTIN, GTIN-8, GTIN-12, GTIN-13, GTIN-14, ISBN, and MPN) are also searchable from both the front-end and from the WooCommerce Products page.</strong></p>
